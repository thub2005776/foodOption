        ...
        <div>
                    ...
                    <div className="flex justify-center gap-8">
                        <div className="mb-5">
                            ...
                            <input
                                type="text"
                                id="age"
                                className="bg-blue-400 border border-gray-300 text-white text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
            ...
            <div className="">
                ...
                <div className="flex justify-center gap-5">
                    ...
                    <FoodCard 
                        image="https://i.pinimg.com/564x/32/78/68/327868ce18ad5c1feae0829c86d2b21d.jpg"
                        title="Trái cây nhiệt đới tươi"
                        content=""/>
                    <FoodCard 
                        image="https://i.pinimg.com/736x/7b/b8/f1/7bb8f1199ff5629ee24ab0ee8e3c7fd1.jpg"
                        title="Trái cây tươi gọt sẵn"
                        content=""/>
                    <FoodCard 
                        image="https://i.pinimg.com/564x/11/80/dd/1180dda261365658c662064d04c2da73.jpg"
                        title="Trái cây ly"
                        content=""/>
                </div>
            </div>
