...
export default function CartItem({orderID, item , index}: { orderID:string, item: Object, index:React.Key}) {
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th className=" font-bold text-xl text-wrap text-gray-900 whitespace-nowrap dark:text-white">
                            {item['food'].name}
                        </th>
                        <td className="mb-3 font-bold text-red-600 dark:text-red-500">
