    ...
    return (
        <div>
            ...
            :<button
                onClick={() => setOpen(true)}
                type="button"
                className=" text-white bg-gradient-to-br from-yellow-600 to-orange-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-orange-300 dark:focus:ring-orange-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                Sửa
            </button>}
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                        <div className="px-4 py-2 mb-3 bg-white rounded-t-lg dark:bg-gray-800">
                                            <label htmlFor="address" className="sr-only">Địa chỉ mới</label>
