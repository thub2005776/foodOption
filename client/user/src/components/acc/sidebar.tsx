                ...
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <Link to={`/acc/${user['_id'].$oid}/ordered`}>
                            <div
                                className={`${tab === 'order' && "bg-gray-100 dark:bg-gray-700"} flex items-center p-2 hover:cursor-pointer text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                    ...
                    <li>
                        <Link to={`/acc/${user['_id'].$oid}/favorited`}>
                            <div
                                className={`${tab === 'favorited' && "bg-gray-100 dark:bg-gray-700"} flex items-center p-2 hover:cursor-pointer text-gray-900 rounded-lg dark:text-white group`}>
