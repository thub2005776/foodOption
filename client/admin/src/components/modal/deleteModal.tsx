  ...
  function onCloseModal() {
    ...
    return (
        <div>
            ...
            {openModal &&
            <div id="popup-modal" tabIndex={-1} className="fixed top-20 lg:top-32 right-0 left-[30%] lg:left-[50%] z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div className="relative p-4 w-full max-w-md max-h-full ">
                    <div className="relative bg-red-100 rounded-lg shadow dark:bg-gray-700 dark:border dark:border-gray-600">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            onClick={onCloseModal}>No, cancel</button>
                        </div>
                    </div>
                </div>
            </div>}
